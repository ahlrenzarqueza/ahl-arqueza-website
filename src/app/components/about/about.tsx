  ...
  return (
    <div className="flex flex-col">
      ...
      <p className="md:text-2xl mb-2 md:mb-6">
        ...
        for crafting sleek yet efficient web applications, coupled with a knack
        for building powerful APIs and integrating to the cloud.
      </p>
      ...
      <p className="md:text-2xl mb-2 md:mb-6">
        🪄 So, if you&apos;re looking for a tech wiz to bring your web app
        dreams to life, I&apos;m your go-to person!
      </p>
